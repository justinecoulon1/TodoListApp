...
public class MainMenuPanel extends JPanel {
    ...
    public MainMenuPanel() {
        ...
        TabPanel todoListTabPanel = new TabPanel(UiIcons.NORMAL_TODO, "Todo lists", AppPanels.HOME_MAIN_PANEL);
        mainMenuContainerPanel.add(todoListTabPanel, "h 50, wrap, growx");

        TabPanel statisticsTabPanel = new TabPanel(UiIcons.STATISTICS, "Statistics", AppPanels.HOME_MAIN_PANEL);
        mainMenuContainerPanel.add(statisticsTabPanel, "h 50, wrap, growx");

        TabPanel settingsTabPanel = new TabPanel(UiIcons.SETTINGS, "Settings", AppPanels.HOME_MAIN_PANEL);
